  ...
  <div class="content-page">
    <div class="content-nav">
      ...
      >
        ...
        <el-breadcrumb-item>更新广告</el-breadcrumb-item>
      </el-breadcrumb>
...
export default {
  ...
  components: {},
  mounted() {
    this.imgForm.name = this.$route.query.name;
    this.imgForm.media_id = this.$route.query.media_id;
    this.imgForm.image_url = this.$route.query.image_url;
    this.imgForm.id = this.$route.query.id;
    // this.imgForm.ad_position_id = this.$route.query.ad_position_id
